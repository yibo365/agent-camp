      ...
      '/frameworks/': [
        {
          ...
          items: [
            ...
            { text: 'AutoGen (Microsoft)', link: '/frameworks/autogen' },
            { text: 'CrewAI', link: '/frameworks/crewai' },
            { text: 'Semantic Kernel', link: '/frameworks/semantic-kernel' },
            { text: 'Pydantic AI', link: '/frameworks/pydantic-ai' },
            { text: 'Agno', link: '/frameworks/agno' },
      ...
      '/source/': [
        {
          ...
          items: [
            ...
            { text: 'Cursor Agent 模式', link: '/source/cursor' },
            ...
            { text: 'pi-mono / pyMono', link: '/source/pi-mono' },
